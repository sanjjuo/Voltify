        ...
        <>
            <section className='hidden lg:flex'>
                <Navbar expand="lg" className="dark:bg-gray-900 w-full dark:text-white duration-200 relative z-40 shadow-md">
                    <Container>
                        <Navbar.Brand className='!text-primary font-extrabold tracking-tighter text-3xl capitalize cursor-pointer flex items-center'>
                            volt<span className='relative'><BiSolidBolt className='text-2xl' /><RxDotFilled className='absolute top-[-15px] text-2xl' /></span>fy</Navbar.Brand>
                        <Navbar.Toggle aria-controls="basic-navbar-nav" />
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="ms-auto gap-20 flex items-center">
                                <Nav.Link className='!text-gray-500 text-md hover:text-black dark:hover:text-white duration-200 p-0'>Menu</Nav.Link>
                                <Nav.Link className='!text-gray-500 text-md hover:text-black dark:hover:text-white duration-200 p-0'>Shop</Nav.Link>
                                <Nav.Link className='!text-gray-500 text-md hover:text-black dark:hover:text-white duration-200 p-0'>About</Nav.Link>
                                <Nav.Link className='!text-gray-500 text-md hover:text-black dark:hover:text-white duration-200 p-0'>Blog</Nav.Link>
                                <NavDropdown title={<span className='text-gray-500 text-md hover:text-black dark:hover:text-white duration-200 p-0'>Quick Links</span>} id="basic-nav-dropdown">
                                    <NavDropdown.Item href="#action/3.2" className='text-gray-500 hover:bg-secondary/20 hover:text-black dark:bg-gray-900 dark:hover:text-white duration-200'>
                                        Trending Products
                                    </NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.3" className='text-gray-500 hover:bg-secondary/20 hover:text-black dark:bg-gray-900 dark:hover:text-white duration-200'>
                                        Best Selling
                                    </NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.4" className='text-gray-500 hover:bg-secondary/20 hover:text-black dark:bg-gray-900 dark:hover:text-white duration-200'>
                                        Top Rated
                                    </NavDropdown.Item>
                                </NavDropdown>
                            </Nav>
                            <Nav className="ms-auto">
                                <ul className='flex justify-between items-center gap-4 p-0 m-0'>
                                    <li className='relative group hidden sm:block'>
                                        ...
                                        <GoSearch className='text-xl text-gray-600 dark:hover:text-gray-400 absolute top-[-5px] translate-y-1/2 right-1 
                                cursor-pointer hover:text-primary duration-200' />
                                    </li>
                                    <li className='relative'><IoCartOutline className='text-2xl text-gray-600 hover:text-primary cursor-pointer' />
            ...
            <section className='bg-white p-[15px_10px] dark:bg-gray-900 w-full dark:text-white block shadow-md lg:hidden'>
                <div className='flex justify-between items-center'>
                    <div>
                        <h1 className='!text-primary font-extrabold tracking-tighter text-2xl capitalize cursor-pointer flex items-center m-0'>
