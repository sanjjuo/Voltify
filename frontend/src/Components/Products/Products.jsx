            ...
            <div className="container">
                        ...
                        <li>
                            <Nav>
                                <NavDropdown
                                    ...
                                    title={<span className='text-lg text-black dark:!text-white font-light transition-all duration-500 ease-out transform 
                                        scale-100 hover:scale-110 hover:!text-primary'>Headset</span>}
                                    menuVariant="light"
                                >
                                    <NavDropdown.Item href="#action/3.1" onClick={() => handleFilter("headphone")}>Headphones</NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.2" onClick={() => handleFilter("earphone")}>
                                        Earphones
                                    </NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.3" onClick={() => handleFilter("earbud")}>Airpods</NavDropdown.Item>
                                </NavDropdown>
                            </Nav>
                        </li>
                        <li className='text-lg font-light transition-all duration-500 ease-out transform 
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {filter.map((product, index) => (
                        <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} key={index} className='cursor-pointer mt-5'>
                            <div className='relative w-full h-[350px] group overflow-hidden'>
                                <img src={product.image} alt="" className='w-full h-full object-cover transition-all duration-1000 ease-in-out transform scale-100 group-hover:scale-110' />
