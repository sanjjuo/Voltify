        ...
        <>
            <div className='py-8 dark:bg-gray-900'>
                <div className="container">
                    <div className='bg-brandHeadSet flex flex-col justify-between items-center gap-4 lg:flex lg:flex-row lg:justify-between lg:items-center lg:gap-4 rounded-3xl p-4 lg:h-[280px] cursor-pointer group 
                    transition-all duration-300 ease-in-out transform scale-100 hover:scale-105'>
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.9 }} className='w-[100%] h-[350px]'>
                            <img src="headset.png" alt="" className='w-[100%] h-[100%] object-contain drop-shadow-[-8px_4px_6px_rgba(0,0,0,.8)]
                        ...
                        <div className='w-full'>
                            ...
                            <button className='bg-white text-brandHeadSet w-[30%] rounded-3xl p-2 text-xl hover:!bg-gray-900 hover:!text-white'>Shop</button>
                        </div>
                    </div>
                </div>
            </div>
